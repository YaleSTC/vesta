...
RSpec.describe SuitesBySizeQuery do
  ...
  it 'returns a hash mapping suites to their sizes for all suties by default' do
    suite1 = create(:suite_with_rooms, rooms_count: 1)
    suite2 = create(:suite_with_rooms, rooms_count: 2)
  ...
  it 'orders suites by number' do
    suite1 = create(:suite_with_rooms, rooms_count: 1, number: 'b')
    suite2 = create(:suite_with_rooms, rooms_count: 1, number: 'a')
    result = described_class.call
