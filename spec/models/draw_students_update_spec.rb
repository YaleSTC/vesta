  ...
  describe '#update' do
    context 'success' do
      ...
      def create_students_in_year(year)
        create(:student_in_draw, class_year: year)
        student_in_group = create(:drawless_group).leader
        student_in_group.update(class_year: year)
        create(:student, class_year: year)
      end
    end
    ...
    context 'error' do
      ...
      def create_bad_user
        ...
        create(:student, class_year: 2016).tap do |s|
